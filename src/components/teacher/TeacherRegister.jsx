...
<hr className={classes.hr} />
      ...
      <Grid item xs={12} md={12}>
          ...
          <Box className={classes.box}>
          <label className={classes.labelName}> Institute</label>
              <input type="text" required  className={classes.inputfields} className="inputfields"/>
          </Box>
        
          <Box className={classes.box}>

              <Button className={classes.RgBtn}><Link to='/teacherhome' style={{textDecoration:'none',color:'white'}}>Register</Link></Button>
              <Button className={classes.RgBtn}><Link to='/tlogin' style={{textDecoration:'none',color:'white'}}>LogIn</Link></Button>
          </Box>
          </form>
      </Grid>
